...
function takingArray(studentNames, index, value) {
    studentNames.splice(index, 0, value);
    return studentNames;
}
var stuNames = ['usama', 'zaman', 'azeem', 'attique'];
...
var shoppingCart = ["meat", "rice", "sugar", "salt"];
...
function factorial(positiveInteger) {
...
var printFactorial = factorial(5);
...
var temperature = [25, 30, 40, 50, 60];
var temperatureIndex = 0;
while (temperatureIndex < temperature.length) {
    var fahrenheitTemp = (temperature[temperatureIndex] * 9 / 5) + 32;
    var tempArray = [];
